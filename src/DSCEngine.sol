 ...
 * It handles all the logic for minting and redeeming, as well as depositing & withdrawing collateral.
 * @notice This contract this is VERY loosely based on the MakerDAO DSS (DAI) system.
 */
